import random, time
fruits=['pear','mango','apple','strawberry','banana','apricot','pinapple','grapes','blueberry','custard apple','plum','watermelon']
superheroes=['superman','supergirl','batman','aquaman','sandman','spiderman','wonderwoman','ironman','captain america','flash']
movies=["Inside Out","The Princess and the Frog","Beauty and the Beast","Pocahontas","Moana","Abominable"]
